...
1. 10 AM is the money session: 57% win rate (4/7), +$10.38 net. 12 PM went 0/2 (-$4.65); 3:15 PM 1/2 (+$0.19). No position has yet been opened at 1 PM or 2 PM — the bar for a late entry is high; only take a genuinely clean setup. (N=11)
